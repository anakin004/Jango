...
------------------------------------------------------------------------------
	...
	void SceneSerializer::DeSerialize(const std::string& filepath)
	{
		...
		if (!data["Scene"])
		{
			CN_CORE_ERROR("Not a valid scene");
			return;
		}
		std::string SceneName = data["Scene"].as<std::string>();
		CN_CORE_INFO("Deserializing Scene {}", SceneName);
	...
	void SceneSerializer::DeSerializeMaterial(const std::string& filepath, Material& material)
	{
		...
		CN_ASSERT(data["Material ID"], "Invalid key");
		CN_ASSERT(data["Color"], "Invalid key");
		CN_ASSERT(data["Roughness"], "Invalid key");
		CN_ASSERT(data["Metallic"], "Invalid key");
		CN_ASSERT(data["Emission"], "Invalid key");
		CN_ASSERT(data["Normal Strength"], "Invalid key");
		CN_ASSERT(data["Albedo Map"], "Invalid key");
		CN_ASSERT(data["Normal Map"], "Invalid key");
		CN_ASSERT(data["Roughness Map"], "Invalid key");
